...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Prince-150/Apporoval/blob/main/Apporved.txt').text
        ff=open('show.txt','w')
...
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : PRINCE RONI          │ 
\033[1;37m│ ❲★❳ GITHUB   :             |
\033[1;37m│ ❲★❳ WHATSAPP : +8801916564949        │
...
def approval():
  ...
  id = "4h".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Prince-150/Apporoval/blob/main/Apporved.txt').text
    if id in httpCaht:
